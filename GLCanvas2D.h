...
namespace GLView {
	...
	protected:
		...
		/// </summary>
		virtual void OnRender(GLView::Canvas2DRenderEventArgs^ e) 
		{
			Render(this, e);
		}
		/// <summary>
		...
		/// </summary>
		virtual void OnMouseSelect(GLView::Canvas2DMouseSelectEventArgs^ e)
		{
			MouseSelect(this, e);
		}
	...
	public:
		...
		delegate void RenderHandler(System::Object^ sender, GLView::Canvas2DRenderEventArgs^ e);
		/// <summary>
		...
		[EditorBrowsable(EditorBrowsableState::Never)]
		delegate void MouseSelectHandler(System::Object^ sender, GLView::Canvas2DMouseSelectEventArgs^ e);
