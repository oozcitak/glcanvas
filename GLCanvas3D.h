...
namespace GLView 
{
	...
	public:
		...
		property GLView::Camera ^ Camera
		{ 
			virtual GLView::Camera ^ get(void) { return mCamera; } 
		}
		/// <summary>
        /// Gets the model origin as drawn in the last render.
        /// </summary>
		[Category("Appearance"), Description("Gets the model origin."), Browsable(false)]
		property GLView::Point3D ModelOrigin
		{ 
			virtual GLView::Point3D get(void) { return mOrigin; } 
		}
		/// <summary>
		...
		/// </summary>
		[Category("Behavior"), Browsable(true), DefaultValue(GLView::GLCanvas3D::SelectMode::typeid, "None"), Description("Gets or sets the mouse selection mode.")]
	...
	protected:
		...
		/// </summary>
		virtual void OnRender(GLView::Canvas3DRenderEventArgs^ e) 
		{
			Render(this, e);
		}
		/// <summary>
		...
		/// </summary>
		virtual void OnMouseSelect(GLView::Canvas3DMouseSelectEventArgs^ e)
		{
			MouseSelect(this, e);
		}
	...
	public:
		...
		delegate void RenderHandler(System::Object^ sender, GLView::Canvas3DRenderEventArgs^ e);
		/// <summary>
		/// Represents the method that will handle the Render event. 
		/// </summary>
		/// <param name="sender">The GLCanvas3D object that is the source of the event.</param>
		...
		[EditorBrowsable(EditorBrowsableState::Never)]
		delegate void MouseSelectHandler(System::Object^ sender, GLView::Canvas3DMouseSelectEventArgs^ e);
